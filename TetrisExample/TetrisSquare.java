...
public class TetrisSquare {
    ...
    */
    public int getRelativeX(TetrisSquare centerSquare) {
    ...
    */
    ...
    public int getRelativeY(TetrisSquare centerSquare) {
    ...
    */
    ...
    public void setRelativeLocation(int relativeX, int relativeY, TetrisSquare centerSquare) {
